module echo_delay_BRAM #(
    ...
    localparam [ECHO_ADDR_WIDTH-1:0] LAST_ECHO_ADDR = MAX_DELAY_SAMPLES - 1;
    localparam [ECHO_ADDR_WIDTH:0] MAX_DELAY_COUNT = MAX_DELAY_SAMPLES;
    ...
    wire delay_enabled = (bounded_delay_samples != {ECHO_ADDR_WIDTH{1'b0}});
